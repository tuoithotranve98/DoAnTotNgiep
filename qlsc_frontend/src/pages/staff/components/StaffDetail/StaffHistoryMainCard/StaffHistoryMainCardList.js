...
const mapDispatchToProps = (dispatch) => ({
  onGetStaffHistoryMainCard: (search, option) => dispatch(getListStaffHistoryMainCard(search, option)),
});

export default React.memo(connect(null, mapDispatchToProps)(StaffHistoryMainCardList));
