...
import './styles.scss';
function InfoCustomerFooter(props) {
  return (
    <div className="info-customer-footer">
...
InfoCustomerFooter.defaultProps = {

};
export default React.memo(connect(null, null)(InfoCustomerFooter));
