    ...
    <div className="info-customer-warpper">
      ...
      {showFilterCustomer ? (
        ...
        <SearchCustomer
          ...
          setShowModalCustomer={(a)=>props.setShowModalCustomer(a)}
        />
      )}
    </div>
  );
